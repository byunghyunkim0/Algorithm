...
뱀의 이동 경로의 정보를 저장하는 Deque를 작성<br>
이동하는 위치에 사과가 있다면 Deque에 첫번째에 해당 위치를 저장<br>
이동하는 위치에 사과가 없다면 Deque에 첫번째에 해당 위치를 저장하고 Deque에 마지막 위치에 대한 정보를 삭제<br>
각각의 명령을 실행하면서 바깥으로 나가거나, visited 배열을 이용하여 방문하고 있는 위치에 방문을 하면 종료