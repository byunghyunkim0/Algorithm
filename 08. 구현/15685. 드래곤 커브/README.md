...
방향을 저장하는 배열을 생성하고 배열의 길이는 2<sup>repeat</sup>만큼 생성<br>
x, y의 위치와 방향을 저장<br>
방향의 데이터는 저장된 방향에 대해서 +1로 저장<br>
처음 위치에서 방향에 따른 위치를 이동하면서 방문 체크<br>
map에서 하나씩 방문하면서 주위에 모두 방문한 개수를 센다.