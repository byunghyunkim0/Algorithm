...
home의 좌표에서 1000m 이내에 편의점이 있다면 방문 처리를 진행하고 queue에 저장 (최대 맥주의 개수 * 맥주 한 병당 갈수있는 거리)

현재 방문하고 있는 좌표에서 락 페스티벌이 1000m 이내에 있다면 탐색 종료

락 페스티벌에 도착할 수 있다면 happy 없다면 sad를 출력