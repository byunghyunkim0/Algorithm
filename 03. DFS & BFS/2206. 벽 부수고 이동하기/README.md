...
최단 경로로 목적지를 찾아야되기 때문에 BFS를 사용<br>
벽을 부셨는지 유무를 저장하면서 BFS를 진행<br>
map에도 벽을 부수고 온 경우와 부수고 오지 않은 경우를 나누어서 거리를 갱신<br>
목적지에서 두 거리를 비교하여 짧은 거리를 출력